...
export const resetPasswordTemplate = (token) => {
    ...
    return emailLayout({
        ...
        content: `
            ...
            <p style="${STYLES.text}">We received a request to reset the password for your ${CONFIG.SITE_NAME} account. No worries, it happens!</p>
            
            <div style="text-align: center; margin-bottom: 32px;">
                <a href="${resetUrl}" style="${STYLES.button}">Reset My Password</a>
            </div>
