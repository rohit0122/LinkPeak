...
export const welcomeTemplate = ({ name }) => {
    ...
    return emailLayout({
        ...
        content: `
            ...
            <p style="font-size: 16px; font-weight: 600; color: #111827; margin-bottom: 16px;">Here's how to get started in 3 minutes:</p>
            ...
            <div style="text-align: center;">
                <a href="${dashboardUrl}" class="button">Create My Bio Page</a>
            </div>

            <p style="font-size: 16px; color: #4B5563; margin-top: 32px;">We're thrilled to have you here. If you need any help, just reply to this email!</p>
        `
    });
};
