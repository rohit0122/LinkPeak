 ...
 * Call this on dashboard init or currentUser login
 */
export async function activateScheduledSubscriptions(userId) {
    try {
        ...
        console.log(`Activated scheduled subscription for currentUser ${userId}: ${subToActivate.planId}`);
        return true;
    } catch (error) {
