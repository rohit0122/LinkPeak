                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                <div className="space-y-6">
                                    <div className="form-control">
                                        <label className="label uppercase tracking-widest text-[10px] font-bold opacity-50" htmlFor="contact-name">Full Name</label>
                                        <input
                                            id="contact-name"
                                            type="text"
                                    ...
                                    <div className="form-control">
                                        <label className="label uppercase tracking-widest text-[10px] font-bold opacity-50" htmlFor="contact-email">Email Address</label>
                                        <input
                                            id="contact-email"
                                            type="email"
                                    ...
                                    <div className="form-control">
                                        <label className="label uppercase tracking-widest text-[10px] font-bold opacity-50" htmlFor="contact-subject">What can we help with?</label>
                                        <select
                                            id="contact-subject"
                                    ...
                                    <div className="form-control">
                                        <label className="label uppercase tracking-widest text-[10px] font-bold opacity-50" htmlFor="contact-message">Message Details</label>
                                        <textarea
                                            id="contact-message"
