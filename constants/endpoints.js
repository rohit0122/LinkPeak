...
export const ENDPOINTS = {
  ...
  ADMIN: {
    ...
    OVERRIDE_PLAN: (id) => `/admin/users/${id}/override-plan`,
    TICKETS: "/admin/tickets",
    TICKET_BY_ID: (id) => `/admin/tickets/${id}`,
    PLANS: "/admin/plans",
    PLAN_BY_ID: (id) => `/admin/plans/${id}`,
    PAYMENTS: "/admin/payments",
    WEBHOOK_LOGS: "/admin/webhook-logs",
...
export const BACKEND_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    USER_BY_ID: (id) => `${BACKEND_URL}/api/v1/admin/users/${id}`,
    SUSPEND: `${BACKEND_URL}/api/v1/admin/user/suspend`,
    OVERRIDE_PLAN: (id) => `${BACKEND_URL}/api/v1/admin/users/${id}/override-plan`,
    ...
    PAYMENTS: `${BACKEND_URL}/api/v1/admin/payments`,
    WEBHOOK_LOGS: `${BACKEND_URL}/api/v1/admin/webhook-logs`,
