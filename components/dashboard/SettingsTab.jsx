...
export default function SettingsTab({
  ...
  return (
    <div className="flex flex-col gap-8">
        ...
        <div className="card-body p-8 lg:p-10">
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="flex-none flex flex-col items-center gap-4">
              <div className="relative group">
                <ProfileUpload
                  currentImage={mergedBioPage?.profile_image}
                  userId={currentUser?.id}
                  onUpload={onImageUpload} // Use prop
                />
              </div>
            </div>
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text">
                      Display Title <span className="text-error">*</span>
                    </span>
                  </label>
                  <input
                    type="text"
          ...
          <div className="form-control">
            ...
            <p className="text-xs opacity-50 mb-4">
              Add your social profiles. They&apos;ll appear at the bottom of
              your bio page.
            </p>
              ...
              <div className="form-control">
                <label className="input input-bordered flex items-center gap-2">
                  ...
                  <input
                    ...
                    value={mergedBioPage?.social_links?.instagram || ""}
                    onChange={(e) => {
                      setTempPageData({
                        social_links: {
                          ...mergedBioPage.social_links,
              ...
              <div className="form-control">
                <label className="input input-bordered flex items-center gap-2">
                  ...
                  <input
                    ...
                    value={mergedBioPage?.social_links?.twitter || ""}
                    onChange={(e) => {
                      setTempPageData({
                        social_links: {
                          ...mergedBioPage.social_links,
              ...
              <div className="form-control">
                <label className="input input-bordered flex items-center gap-2">
                  ...
                  <input
                    ...
                    value={mergedBioPage?.social_links?.facebook || ""}
                    onChange={(e) => {
                      setTempPageData({
                        social_links: {
                          ...mergedBioPage.social_links,
              ...
              <div className="form-control">
                <label className="input input-bordered flex items-center gap-2">
                  ...
                  <input
                    ...
                    value={mergedBioPage?.social_links?.linkedin || ""}
                    onChange={(e) => {
                      setTempPageData({
                        social_links: {
                          ...mergedBioPage.social_links,
              ...
              <div className="form-control">
                <label className="input input-bordered flex items-center gap-2">
                  ...
                  <input
                    ...
                    value={mergedBioPage?.social_links?.github || ""}
                    onChange={(e) => {
                      setTempPageData({
                        social_links: {
                          ...mergedBioPage.social_links,
              ...
              <div className="form-control">
                <label className="input input-bordered flex items-center gap-2">
                  ...
                  <input
                    ...
                    value={mergedBioPage?.social_links?.youtube || ""}
                    onChange={(e) => {
                      setTempPageData({
                        social_links: {
                          ...mergedBioPage.social_links,
              ...
              <div className="form-control">
                <label className="input input-bordered flex items-center gap-2">
                  ...
                  <input
                    ...
                    value={mergedBioPage?.social_links?.tiktok || ""}
                    onChange={(e) => {
                      setTempPageData({
                        social_links: {
                          ...mergedBioPage.social_links,
      ...
      <div
        key={mergedBioPage?.id}
        className="card relative overflow-hidden bg-slate-900 text-white shadow-xl shadow-slate-900/20 border border-slate-700/50 lg:col-span-2 group"
      >
        ...
        <div className="card-body p-6 relative z-10 space-y-6">
          ...
          <div className="badge badge-info badge-sm uppercase font-medium">
            Optimizing: {mergedBioPage?.title}
          </div>
              ...
              >
                ...
                <span className="relative z-10 font-bold flex items-center gap-2">
                  {isSeoAiLoading ? (
                    ...
                    <>
                      <RiMagicLine
                        className="text-2xl text-primary transition 
...
group-hover:text-secondary"
          ...
          >
            ...
            <div className="form-control h-full relative group/seo">
              ...
              <textarea
                className="textarea h-24 bg-slate-900/50 border-white/10 text-white placeholder-white/20 focus:border-primary/50 focus:bg-slate-900/80 transition-all font-medium text-sm w-full"
          ...
          <div className="flex items-center justify-between px-2">
            <div className="flex items-center gap-2 text-xs font-bold text-white/30 uppercase tracking-wider">
              {mergedBioPage?.seo?.title && mergedBioPage?.seo?.description ? (
                <>
