...
import { RiPaletteLine, RiLayoutMasonryLine, RiShieldStarLine } from "react-icons/ri";

export default function ThemeTab({ page, currentUser, onUpdate }) {
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <section>
                ...
                <TemplateSelector
                    ...
                    onSelect={(t) => onUpdate({ template: t })}
                />
            </section>
