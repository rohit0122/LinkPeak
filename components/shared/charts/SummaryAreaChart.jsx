...
export default function SummaryAreaChart({ summaryChart, plan }) {

    {/* Engagement Chart */ }
    return (
        <div className="card bg-base-100 shadow-sm border border-base-300">
            <div className="card-body p-6">
                <ChartRangeSelector plan={plan} title="Engagement Over Time" subtitle="Clicks vs Views distribution for selected period" />
                {summaryChart && summaryChart.length > 0 ? (<div style={{ width: "100%", height: 400 }}>
