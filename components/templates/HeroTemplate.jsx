            ...
            {heroLink && (
                ...
                >
                    <div className="relative z-10 flex flex-col items-start gap-4">
                        <div className="badge badge-secondary/80 font-bold p-3 animate-pulse">FEATURED</div>
                        <div className="flex items-center gap-4">
                            {heroLink.icon && <span className="text-4xl">{heroLink.icon}</span>}
                            <h2 className="text-3xl font-medium leading-none">{heroLink.title}</h2>
                        </div>
