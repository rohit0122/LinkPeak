    ...
    return (
        ...
        >
            ...
            <div className="relative bg-base-100/50 backdrop-blur-xl p-8 rounded-[2.5rem] text-center shadow-xl shadow-base-content/5 border border-white/20 mb-8 overflow-hidden group">
                ...
                <h1 className="text-2xl font-extrabold text-base-content mb-2 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-base-content to-base-content/60">{page?.title || "Untitled"}</h1>
